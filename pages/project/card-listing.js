...
import img1 from '../../public/img/theme/light/brand-avatar-1.png';
import img2 from '../../public/img/theme/light/brand-avatar-2.png';
import img3 from '../../public/img/theme/light/brand-avatar-3.png';

export default function ProjectCardListing() {
  return (
    <>
      <Navbar />
        ...
        <div class="page-title">
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              {/* <!-- Optional link --> */}
              <a href="/project/table-listing" class="text-sm text-info d-none d-lg-inline-block ml-4">See table</a>
            </div>
