...
import img1 from '../../public/img/theme/light/team-1-800x800.jpg';
import img2 from '../../public/img/theme/light/team-2-800x800.jpg';
import img3 from '../../public/img/theme/light/team-2-800x800.jpg';
        ...
        <div class="page-title">
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              {/* <!-- Optional link --> */}
              <a href="/project/card-listing" class="text-sm text-info d-none d-lg-inline-block ml-4">See cards</a>
            </div>
              ...
              <tbody class="list">
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <div>
                        <img alt="Image placeholder" src={img1} class="avatar  rounded-circle"/>
                      </div>
                  ...
                  <td>
                    <div class="avatar-group">
                      <a href="#" class="avatar rounded-circle avatar-sm">
                        <Image alt="Image placeholder" src={img1} class=""/>
                      </a>
                      <a href="#" class="avatar rounded-circle avatar-sm">
                        <Image alt="Image placeholder" src={img2} class=""/>
                      </a>
                      <a href="#" class="avatar rounded-circle avatar-sm">
                        <Image alt="Image placeholder" src={img3} class=""/>
                      </a>
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <div>
                        <img alt="Image placeholder" src={img2} class="avatar  rounded-circle"/>
                      </div>
                      <div class="media-body ml-4">
                ...
                <tr>
                  <th scope="row">
                    <div class="media align-items-center">
                      <div>
                        <img alt="Image placeholder" src={img3} class="avatar  rounded-circle"/>
                      </div>
                      <div class="media-body ml-4">
