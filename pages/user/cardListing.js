...
import img from "../../public/img/theme/light/team-1-800x800.jpg"
        ...
        <div class="page-title">
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              {/* <!-- Optional link --> */}
              <a href="/user/tableListing" class="text-sm text-info d-none d-lg-inline-block ml-4">See table</a>
            </div>
            ...
            <div class="card hover-shadow-lg">
              <div class="card-body text-center">
                <div class="avatar-parent-child">
                  <Image alt="Image placeholder" src={img} width="70px" height="70px" class="avatar  rounded-circle avatar-lg"/>
