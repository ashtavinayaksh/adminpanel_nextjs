...
export default function Projects() {
  return (
    <>
    <Navbar />
      <div class="page-content" style={{paddingLeft:"20px",marginTop:"14px",paddingRight:"20px"}}>
        {/* <!-- Page title --> */}
        <div class="page-title" style={{marginTop:"14px", marginBottom:"14px",}}>
          <div class="row justify-content-between align-items-center">
            <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              {/* <!-- Page title + Go Back button --> */}
              <div class="d-inline-block">
                <h5 class="h4 d-inline-block font-weight-400 mb-0 text-blue">
                  My profile
                </h5>
              </div>
              {/* <!-- Additional info --> */}
              ...
              <div class="card-body">
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="badge badge-xs badge-soft-warning ml-2">
                      <i class="fas fa-arrow-down"></i> 13%
                    </span>
                  </div>
                  <div class="col-4">
                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="text-nowrap h6 text-muted text-sm">
                      $3.068,90
                    </span>
                    <span class="badge badge-xs badge-soft-success ml-2">
                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <span class="badge badge-xs badge-soft-info ml-2">
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="card card-fluid">
              ...
              <div class="card-body">
                <div
                  class="progress-circle progress-lg mx-auto"
                ...
                <div class="row mb-3">
                  <div class="col-9">
                    <div class="progress-wrapper">
                      <span class="progress-label text-muted text-sm">
                        Logo design
                      </span>
