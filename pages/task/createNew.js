...
export default function CreateNew() {
  return (
    <>
      ...
      <div
        class="container-fluid container-application"
        style={{ paddingLeft: "20px", marginTop: "14px", paddingRight: "20px" }}
      >
        {/* <!-- Content --> */}
                ...
                <div class="page-title">
                  <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-6 d-flex align-items-center justify-content-between justify-content-md-end">
                      <a
                        href="#modal-users"
                        class="btn btn-sm btn-white btn-icon rounded-pill"
                        data-toggle="modal"
                      >
                      ...
                      <a
                        href="#"
                        class="btn btn-sm btn-white rounded-circle btn-icon-only"
                      >
                        <span class="btn-inner--icon">
                ...
                <form class="mt-4">
                  <div class="card">
                    <div class="card-body">
                      ...
                      {/* <!-- Task members --> */}
                      <div class="form-group">
                        <label class="form-control-label">Assign member</label>
                        <input type="text" class="form-control" />
                      </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                          ...
                          <ul class="dz-preview dz-preview-multiple list-group list-group-lg list-group-flush">
                            <li class="list-group-item px-0">
                              <div class="row align-items-center">
                                ...
                                <div class="col">
                                  <h6 class="text-sm mb-1" data-dz-name>
                                    ...
                                  </h6>
                                  <p
                      ...
                      <div class="text-right">
                        <a
                          href="#"
                          class="btn btn-link text-sm text-muted font-weight-bold"
                        >
                          Cancel project
                        </a>
                        <button
