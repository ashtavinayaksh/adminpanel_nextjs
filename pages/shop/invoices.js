...
export default function Invoices() {
  ...
  <div class="container-fluid container-application" style={{paddingLeft:"20px",marginTop:"14px",paddingRight:"20px"}}>
    {/* <!-- Content --> */}
            ...
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Purpose Website UI</a></h6>
                  </div>
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Website Redesign</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Webpixels Website</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Purpose Dashboard UI</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Bootstrap Framework</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Component Library</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Website Builder</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
          ...
          <div class="col-lg-4">
            <div class="card hover-shadow-lg">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col-10">
                    <h6 class="mb-0"><a href="invoice-description.html">Website Launch</a></h6>
                  </div>
                  <div class="col-2 text-right">
                    <div class="actions">
                      <div class="dropdown" data-toggle="dropdown">
