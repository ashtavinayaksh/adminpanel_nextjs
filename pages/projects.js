...
export default function Projects() {
  return (
    <>
      <Navbar />
      <div className="page-content" style={{paddingLeft:"20px",marginTop:"14px",paddingRight:"20px"}}>
        {/* <!-- Create project modal --> */}
        <div
          className="modal fade"
          id="modal-project-create"
          tabindex="-1"
          role="dialog"
          aria-hidden="true"
        >
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              <div className="modal-body">
                ...
                {/* <!-- Project privacy --> */}
                <div className="form-group">
                  <label className="form-control-label">Project privacy</label>
                  <div className="row">
                    <div className="col-4">
                ...
                {/* <!-- Project members --> */}
                <div className="form-group">
                  <label className="form-control-label">Project members</label>
                  <input type="text" className="form-control" />
                </div>
                  ...
                  <div className="list-group-item px-0">
                    <div className="row align-items-center">
                      ...
                      <div className="col ml-n2">
                        <a href="#!" className="d-block h6 text-sm mb-0">
                          John Sullivan
                        </a>
                ...
                {/* <!-- Project tags --> */}
                <div className="form-group">
                  <label className="form-control-label">Project tags</label>
                  <input
                    type="text"
                    className="form-control"
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-sm btn-primary rounded-pill mr-auto"
                  data-dismiss="modal"
                >
                  Save
                </button>
                ...
                <button
                  type="button"
                  className="btn btn-sm btn-link text-danger px-2"
                >
                  Delete
                </button>
              </div>
        ...
        {/* <!-- Page title --> */}
        <div className="page-title" style={{marginLeft:"14px",marginTop:"14px", marginBottom:"14px"}}>
          <div className="row justify-content-between align-items-center">
            <div className="col-md-6 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
              ...
              <div className="d-inline-block">
                <h5 className="h4 d-inline-block font-weight-400 mb-0 text-blue">
                  Projects
                </h5>
              </div>
              {/* <!-- Additional info --> */}
              <div className="align-items-center ml-4 d-inline-flex">
                ...
                <span className="text-sm opacity-7 text-blue">
                  Running projects
                </span>
              </div>
              {/* <!-- Optional link --> */}
              <a
                href="card-listing.html"
                className="text-sm text-info d-none d-lg-inline-block ml-4"
              >
                See cards
              </a>
            </div>
                  ...
                  <th scope="row">
                    <div className="media align-items-center">
                      <div>
                        <img
                          alt="Image placeholder"
                          src="../../assets/img/theme/light/brand-avatar-6.png"
                          className="avatar  rounded-circle"
                        />
                      </div>
                      <div className="media-body ml-4">
        ...
        <div className="mt-4 text-center">
          <a
            href="#"
            className="btn btn-sm btn-neutral rounded-pill shadow hover-translate-y-n3"
          >
            Load more ...
          </a>
        </div>
