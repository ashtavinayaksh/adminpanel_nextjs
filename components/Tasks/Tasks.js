              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-body">
                    ...
                    {/* <!-- Project members --> */}
                    <div class="form-group">
                      <label class="form-control-label">Task members</label>
                      <input type="text" class="form-control" />
                    </div>
                    <div class="list-group list-group-flush mb-4">
                      <div class="list-group-item px-0">
                        <div class="row align-items-center">
                          ...
                          <div class="col ml-n2">
                            <a href="#!" class="d-block h6 text-sm mb-0">
                              John Sullivan
                            </a>
                    ...
                    {/* <!-- Project tags --> */}
                    <div class="form-group">
                      <label class="form-control-label">Task tags</label>
                      <input
                        type="text"
                        class="form-control"
                        value="HTML, CSS3, Bootstrap, Photoshop, VueJS"
                        data-toggle="tags"
                ...
                <div class="modal-content">
                  <div class="modal-header row">
                    ...
                    <div class="col-auto">
                      <div class="actions text-right">
                        <a
                          href="#"
                          class="action-item action-favorite active"
                          data-toggle="tooltip"
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row mb-4 align-items-center">
                      <div class="col-6">
                        <label class="form-control-label mb-0">Checklist</label>
                      </div>
                      <div class="col-6 text-right">
                        <a
                          href="#"
                          class="btn btn-xs btn-secondary btn-icon rounded-pill"
                        >
                        ...
                        <div class="px-3 py-2 row align-items-center">
                          <div class="col-10">
                            <div class="custom-control custom-checkbox">
                              ...
                              />
                              <label
                                class="custom-control-label h6 text-sm"
                                for="check-item-1"
                              >
                                Call with Dave
                              </label>
                    ...
                    <hr />
                    {/* <!-- Tab title --> */}
                    <label class="form-control-label mb-4">Attachments</label>
                    {/* <!-- Files --> */}
                      ...
                      <div class="px-3 py-3">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <img
                              alt="Image placeholder"
                              src="../../assets/img/icons/files/pdf.png"
                              class="img-fluid"
                              style={{ width: "40px" }}
                            />
                          </div>
                          <div class="col ml-n2">
                            ...
                            <p class="card-text small text-muted">189 KB</p>
                          </div>
                      ...
                      <div class="px-3 py-3">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <img
                              alt="Image placeholder"
                              src="../../assets/img/icons/files/psd.png"
                              class="img-fluid"
                              style={{ width: "40px" }}
                            />
                          </div>
                          <div class="col ml-n2">
                            ...
                            <p class="card-text small text-muted">45.9 MB</p>
                          </div>
                          <div class="col-auto actions">
                            <div class="dropdown" data-toggle="dropdown">
                              <a
                      ...
                      <div class="px-3 py-3">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <img
                              alt="Image placeholder"
                              src="../../assets/img/icons/files/doc.png"
                              class="img-fluid"
                              style={{ width: "40px" }}
                            />
                          </div>
                          <div class="col ml-n2">
                            ...
                            <p class="card-text small text-muted">87 KB</p>
                          </div>
                          <div class="col-auto actions">
                            <div class="dropdown" data-toggle="dropdown">
                              <a
                      ...
                      <div class="px-3 py-3">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <img
                              alt="Image placeholder"
                              src="../../assets/img/icons/files/avi.png"
                              class="img-fluid"
                              style={{ width: "40px" }}
                            />
                          </div>
                          <div class="col ml-n2">
                            ...
                            <p class="card-text small text-muted">23 MB</p>
                          </div>
                          <div class="col-auto actions">
                            <div class="dropdown" data-toggle="dropdown">
                              <a
                      ...
                      <div class="px-3 py-3">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <img
                              alt="Image placeholder"
                              src="../../assets/img/icons/files/png.png"
                              class="img-fluid"
                              style={{ width: "40px" }}
                            />
                          </div>
                    ...
                    <hr />
                    <label class="form-control-label mb-4">Activity</label>
                      ...
                      <div class="list-group-item px-0">
                        <div class="row align-items-center">
                          ...
                          <div class="col ml-n2">
                            <a
                              href="#!"
                              class="d-block h6 text-sm font-weight-light mb-0"
                            >
                              Martin added a new task to <strong>To Do</strong>{" "}
                              list
                            </a>
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col ml-n2">
                            <a
                              ...
                              class="d-block h6 text-sm font-weight-light mb-0"
                            >
                              Jessie added <strong>Checklist</strong> to this
                              card
                            </a>
                        ...
                        <div class="row align-items-center">
                          ...
                          <div class="col ml-n2">
                            <a
                              ...
                              class="d-block h6 text-sm font-weight-light mb-0"
                            >
                              Martin added <strong>Jessie</strong> to the team
                            </a>
                      ...
                      <div class="card-list-body" id="kanban-blacklist">
                        <div class="card card-progress draggable-item border shadow-none">
                          <div class="card-body">
                            <div class="row align-items-center mb-2">
                              <div class="col-6">
                                <span class="badge badge-pill badge-xs badge-success">
                                  Priority
                                </span>
                              </div>
                              <div class="col-6 text-right">
                            ...
                            <div class="row align-items-center">
                              ...
                              <div class="col-4 text-right">
                                <a
                                  href="#"
                                  class="avatar avatar-sm rounded-circle m-0"
                                >
                                  <img
                                    alt="Image placeholder"
                                    src="../../assets/img/theme/light/team-1-800x800.jpg"
                        ...
                        <div class="card card-progress draggable-item border shadow-none">
                          <div class="card-body">
                            <div class="row align-items-center mb-2">
                              <div class="col-6">
                                <span class="badge badge-pill badge-xs badge-warning">
                                  Priority
                                </span>
                              </div>
                              <div class="col-6 text-right">
                        ...
                        <div class="card card-progress draggable-item border shadow-none">
                          <div class="card-body">
                            <div class="row align-items-center mb-2">
                              <div class="col-6">
                                <span class="badge badge-pill badge-xs badge-info">
                                  Priority
                                </span>
                              </div>
                              <div class="col-6 text-right">
                        ...
                        <div class="card card-progress draggable-item border shadow-none">
                          <div class="card-body">
                            <div class="row align-items-center mb-2">
                              <div class="col-6">
                                <span class="badge badge-pill badge-xs badge-danger">
                                  Priority
                                </span>
                              </div>
                              <div class="col-6 text-right">
